...
export const NODES: ContentNode[] = [
  {
    ...
    "project": {
      "role": "프론트엔드 개발자. 필요하면 기획과 디자인, 서버까지.",
  ...
  },
  {
    ...
    "region": "frontend",
    "kicker": "핵심 영역",
    "sum": "퍼블리싱으로 시작해 React·Angular·Next.js까지. 화면을 만드는 일이 곧 사용자의 시간을 아끼는 일이라고 생각합니다.",
  ...
  },
  {
    ...
    "region": "backend",
    "kicker": "확장 중인 영역",
    "sum": "화면 뒤가 궁금해서 넘어간 영역입니다. NestJS·TypeORM·PostgreSQL로 API와 DB를 직접 설계했습니다.",
  ...
  },
  {
    ...
    "region": "ai",
    "kicker": "현재 집중",
    "sum": "AI를 코드 생성기가 아니라 검증 가능한 프로세스로 다루려고 합니다. 판단과 책임은 사람이 집니다.",
  ...
  },
  {
    ...
    "region": "product",
    "kicker": "일하는 방식",
    "sum": "기획·디자인·개발의 관점 차이를 조율해 결과물을 완성하는 일. 코드 바깥의 절반입니다.",
  ...
  },
  {
    ...
    "region": "lab",
    "kicker": "손이 기억하는 것",
    "sum": "업무 밖에서 만든 것들. 캔버스, 3D, 게임 — 화면을 다루는 감각을 유지하는 방법입니다.",
